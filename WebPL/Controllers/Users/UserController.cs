    ...
    public class UserController : Controller
    {
        ...
        public ActionResult SignIn(User user)
        {
            if (ModelState.IsValidField("Login") && ModelState.IsValidField("Password")
                && !userLogic.GetNeedUsers(user.Login, user.Password.GetHashCode()).Any())
            {
            ...
            if (ModelState.IsValidField("Login") && ModelState.IsValidField("Password"))
            {
                User MyProfile = userLogic.GetNeedUsers(user.Login, user.Password.GetHashCode()).FirstOrDefault();
        ...
        {
            if (userLogic.GetNeedUsers(user.Login, user.Password.GetHashCode()).Any())
            {
        ...
        public ActionResult UpdateFirstName(User user)
        {
            ...
            {
                userLogic.UpdateFirstName((int)TempData.Peek("ID"), user.FirstName);
        ...
        public ActionResult UpdateLastName (User user)
        {
            ...
            {
                userLogic.UpdateLastName((int)TempData.Peek("ID"), user.LastName);
        ...
        public ActionResult UpdateTelephoneNumber (User user)
        {
            ...
            {
                userLogic.UpdateTelephoneNumber((int)TempData.Peek("ID"), user.TelephoneNumber);
